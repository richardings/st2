...
* Fix cancellation specified in concurrency policies to cancel actions appropriately. Previously, mistral
  workflow is orphaned and left in a running state. (bug fix) See https://github.com/StackStorm/st2/pull/3125
  and https://github.com/StackStorm/st2/pull/3151
* Update st2rulesengine to exit non-0 on failure (bug fix) See https://github.com/StackStorm/st2/pull/3394
